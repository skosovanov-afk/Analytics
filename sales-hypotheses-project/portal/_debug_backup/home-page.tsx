              ...
              {sessionEmail ? (
                ...
                <>
                  <div className="subcard">
                    <div style={{ fontWeight: 600, marginBottom: 6 }}>Email Login Paused</div>
                    <div className="muted2" style={{ whiteSpace: "pre-wrap" }}>
                      {emailLoginPaused
                        ? `Sign-in via work email is temporarily disabled.\nAllowed domain was: ${allowedDomain}`
