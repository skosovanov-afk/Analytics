...
export default function TelegramAnalyticsPage() {
  ...
  const DONUT_COLORS = ["#fca5a5", "#f87171", "#fb923c", "#facc15", "#a78bfa", "#86efac", "#7dd3fc", "#f9a8d4"];
  ...
  return (
    <main>
      <AppTopbar title="Telegram Analytics" subtitle="Telegram outreach & meetings performance" />
      ...
      <div className="page grid">
        ...
        <div className="card" style={{ gridColumn: "span 12" }}>
          <div className="cardHeader">
            <div>
              <div className="cardTitle">Telegram Outreach Analytics</div>
